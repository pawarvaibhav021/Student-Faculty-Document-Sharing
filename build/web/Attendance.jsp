...
<html>
       ...
       if(sessionStorage.getItem("visit")==="0"||sessionStorage.getItem("opened_once")!="1")
      {
          top.window.location.href="index.jsp";
            ...
            function uploadAttendance(){
                document.getElementById('table').action="UploadAttendance.jsp";
                document.table1.submit();
            }
            function viewAttendance(){
                document.getElementById('table').action="ViewAttendance.jsp";
                document.table1.submit();
            }
    ...
    <center>
        ...
        <form name="table1" action="UploadAttendance.jsp" id="table" method="get">
            ...
            <table cellpadding="5" id=selection>
               <tr id="top"></tr>
                ...
                <tr>
                <td >
                <input type="button" id="attendance" onclick="uploadAttendance()" value="Upload Attendance">
                    </td>
                <td >
                <input type="button" id="viewattendance" onclick="viewAttendance()" value="View Attendance">
                    </td>    
                </tr>
                <tr id="bottom"></tr>
            </table>
