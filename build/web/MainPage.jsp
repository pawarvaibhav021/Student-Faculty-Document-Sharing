...
<html>
    ...
    <body id="body1">
        <div id="top">
            ...
            <button id="upload" onclick="upload()">Upload Documents</button>
            <button id="attendance" onclick="Attendance()">Attendance</button>
            <button id="result" onclick="Result()">Result</button>  
            <button id="timetable" onclick="TimeTable()">Time Table</button>
        ...
        function deselect()
        {
            ...
            document.getElementById('upload').style.background='rgba(56,66,108,1)'; //when upload button deselected color changes to normal
            ...
            document.getElementById('timetable').style.background='rgba(56,66,108,1)';
        ...
        {
            select('upload');
            document.getElementById('frame1').src="UploadDocuments.jsp";
        }
        function Attendance()
        {
            select('attendance');
        ...
        {
            select('timetable');
             document.getElementById('frame1').src="TimeTable.jsp";
        }
        function logout()
        {
