 ...
 * @author vaibhav
 */
@WebServlet(name = "DeleteNoticeText", urlPatterns = {"/DeleteNoticeText"})
public class DeleteNoticeText extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            PreparedStatement ps1=con.prepareStatement("delete from "+field+"notice where id=?");            
