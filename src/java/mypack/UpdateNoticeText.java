 ...
 * @author vaibhav
 */
@WebServlet(name = "UpdateNoticeText", urlPatterns = {"/UpdateNoticeText"})
public class UpdateNoticeText extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            PreparedStatement ps1=con.prepareStatement("update "+field+"notice set name=?,text=? where id=?");

            ps1.setString(1,noticeName);
